...
if Drawing and Drawing.new then
    ...
    local function createGUICircle(color)
        local frame = Instance.new("Frame")
        ...
        innerCircle.Size = UDim2.new(1, -4, 1, -4)
        ...
        innerCircle.ImageColor3 = Color3.fromRGB(25, 25, 30)
    ...
    FOVCircleGUI = createGUICircle(Color3.fromRGB(255, 255, 255))
    SilentFOVCircleGUI = createGUICircle(Color3.fromRGB(255, 100, 100))
end
