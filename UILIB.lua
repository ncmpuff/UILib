...
function UILib:CreateTextbox(panel, config)
    ...
    -- Textbox
    local textbox = Instance.new("TextBox", panel.ScrollingFrame)
    textbox.Size = UDim2.new(1, -60, 0, 45)
    textbox.Position = UDim2.fromOffset(30, y + 25)
    textbox.BackgroundColor3 = Color3.fromRGB(45, 45, 55)
    textbox.Text = defaultText
    textbox.PlaceholderText = placeholder
    textbox.Font = Enum.Font.GothamMedium
    textbox.TextSize = 15
    textbox.TextColor3 = UILib.Colors.TEXT_PRIMARY
    ...
    textbox.FocusLost:Connect(function()
        ...
        -- Execute callback when focus is lost
