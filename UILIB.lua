    ...
    function UILib:CreateLoadingScreen(config)
        ...
        local accentColor = config.AccentColor or Color3.fromRGB(0, 200, 255) -- Default Blue
    ...
    function UILib:CreateToggle(panel, config)
        ...
        track.BackgroundColor3 = initialState and color or UILib.Colors.TOGGLE_OFF
        ...
        local function toggle()
            ...
            TweenService:Create(track, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                {BackgroundColor3 = state and color or UILib.Colors.TOGGLE_OFF}):Play()
            ...
            if result == false then
                ...
                task.wait(0.05)
                track.BackgroundColor3 = state and color or UILib.Colors.TOGGLE_OFF
    ...
    function UILib:CreateCollapsibleToggle(panel, config)
        ...
        for _, subConfig in ipairs(subToggles) do
            ...
            subTrack.BackgroundColor3 = (subConfig.Default or false) and color or UILib.Colors.TOGGLE_OFF
            ...
            local function subToggle(force)
                ...
                TweenService:Create(subTrack, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                    {BackgroundColor3 = subState and color or UILib.Colors.TOGGLE_OFF}):Play()
    ...
    function UILib:CreateKeybind(panel, config)
        ...
        container.BackgroundTransparency = 0.9 -- Slightly transparent theme color
