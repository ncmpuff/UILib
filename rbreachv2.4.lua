...
-- Create dropdown with items (now with integrated search)
UILib:CreateDropdown(PlayerPanel, {
    Label = "Select Item",
    Options = allItems,
    EnableSearch = true, -- Enable the built-in search feature
    ...
    Callback = function()
        local success, err = pcall(function()
            ...
            if targetItem and targetItemModel then
                ...
                -- Teleport to item (slower, more stable approach)
                myRoot.CFrame = targetItem.CFrame * CFrame.new(0, 2, 0)
                task.wait(0.2) -- Longer initial wait for stability
                ...
                -- Teleport back with anti-trip protection
