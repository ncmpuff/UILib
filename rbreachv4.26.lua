...
LocalPlayer.CharacterAdded:Connect(function(character)
    ...
    character.ChildAdded:Connect(function(child)
        ...
        if child:IsA("Tool") and (now - lastChildAddTime) > 0.1 then
            ...
            weaponStateTable = nil
            print("[DEBUG] Tool equipped:", child.Name, "- Cleared weapon state")
        end
    end)
    ...
    character.ChildRemoved:Connect(function(child)
        if child:IsA("Tool") then
            weaponStateTable = nil
            searchFrameCounter = 0
            print("[DEBUG] Tool removed:", child.Name, "- Cleared weapon state")
        end
    end)
end)
...
local rapidFireConnection = RunService.Heartbeat:Connect(function()
    ...
    -- No longer doing periodic searches - only search on weapon equip via ChildAdded
    -- This eliminates the 5-second lag issue
