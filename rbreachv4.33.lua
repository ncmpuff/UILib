...
local function getPlayerItems(character)
    local items = {}
    local backpack = Players:GetPlayerFromCharacter(character) and Players:GetPlayerFromCharacter(character):FindFirstChild("Backpack")
    if backpack then
    ...
    if equippedItem then
        table.insert(items, equippedItem.Name.. " (Equipped)")
    end
