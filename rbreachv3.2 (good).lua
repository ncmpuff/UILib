            ...
            local success, err = _pcall(function()
                ...
                if targetItem and targetItemModel then
                    ...
                    if distance > 300 then
                        ...
                        UILib:CreateNotification({Text = "Item too far: " .. _math_floor(distance) .. " studs! (Max 300)", Duration = 4})
                        return
                    end
                    
                    log("11. Starting teleport to item")
                    myRoot.CFrame = _CFrame_new(targetItem.Position + _Vector3_new(0, 2, 0))
                    ...
                    if proximityPrompt then
                        ...
                        if proximityPrompt and proximityPrompt.Parent then
                            ...
                            local fireSuccess, fireErr = _pcall(function()
                                ...
                                _fireproximityprompt(proximityPrompt)
...
UILib:CreateButton(PlayerPanel, {
    ...
    Callback = function()
        local success, err = pcall(function()
            ...
            -- Check if escape position is within 300 studs
            if distance > 300 then
                UILib:CreateNotification({
                    Text = "Escape too far: " .. math.floor(distance) .. " studs! (Max 300)",
                    Duration = 4
                })
                return
            end
